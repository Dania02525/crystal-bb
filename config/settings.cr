...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Crystal Bb web application."
  #
  #
  ...
  #
  # settings.secret_key_base= _a07Nb9bF5CgJi6S5_MmeQsjdKERZP4vPhcksErsEag
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("crystal-bb.log", "w"))
  #
  #
end
